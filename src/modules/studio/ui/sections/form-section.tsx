...
import { videoUpdateSchema } from "@/db/schema/videos.schema";
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="flex flex-col gap-6 lg:col-span-2">
          <div className="bg-[#F9F9F9] rounded-xl overflow-hidden h-[240px]">
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
                              variant="ghost"
                              size="icon"
                              className="absolute top-0 right-0 bg-black/50 hover:bg-black/50 rounded-full opacity-100 md:opacity-0 group-hover:opacity-100"
                            >
                          ...
                          <DropdownMenuContent align="start" side="right">
                            ...
                            <DropdownMenuItem
                              onClick={() => restore.mutate({ id: videoId })}
                            >
